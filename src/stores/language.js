...
export const useLanguageStore = defineStore('language', () => {
  ...
  const translations = ref({
    en: {
      ...
      // Footer Advanced
      tanzania: 'Tanzania',
      footerDescription: 'Sustainable Farm-to-Market Program connecting Tanzanian farmers with digital opportunities and global markets.',
      quickLinks: 'Quick Links',
      services: 'Services',
      contactSupport: 'Contact & Support',
      mobileApp: 'Mobile App',
      downloadApp: 'Download our mobile app for on-the-go farming management',
      newsletter: 'Newsletter',
      newsletterDesc: 'Get the latest farming tips and market updates delivered to your inbox.',
      subscriptionSuccess: 'Successfully Subscribed!',
      subscriptionMessage: 'Thank you for subscribing to our newsletter.',
      subscriptionError: 'Subscription Failed',
      subscriptionErrorMessage: 'Please try again later.',
      ...
      dodomaTanzania: 'Dodoma, Tanzania',
    ...
    sw: {
      ...
      // Footer Advanced
      tanzania: 'Tanzania',
      footerDescription: 'Programu Endelevu ya Kilimo hadhara hadhara Soko inayounganisha wakulima wa Tanzania na fursa za kidijitali na masoko ya kimataifa.',
      quickLinks: 'Viungo vya Haraka',
      services: 'Huduma',
      contactSupport: 'Mawasiliano na Msaada',
      mobileApp: 'Programu ya Simu',
      downloadApp: 'Pakua programu yetu ya simu kwa usimamizi wa kilimo wa njiani.',
      newsletter: 'Jarida la Habari',
      newsletterDesc: 'Pata ushauri wa hivi karibuni za kilimo na masasisho ya soko kwenye kijijiji chako.',
      subscriptionSuccess: 'Umefanikiwa Kikamilifu!',
      subscriptionMessage: 'Asante kwa kujiunga na jarida letu la habari.',
      subscriptionError: 'Imeshindwa Kujiunga',
      subscriptionErrorMessage: 'Tafadhali jaribu tena baadaye.',
      allRightsReserved: 'Haki zote zimehifadhiwa.',
      marketplace: 'Soko',
      analytics: 'Uchambuzi',
      training: 'Mafunzo',
      support: 'Msaada',
      hotline: 'Hotline ya Masaa 24/7',
